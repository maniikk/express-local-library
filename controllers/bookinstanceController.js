...
exports.bookinstance_delete_post = function(req, res, next) {
    BookInstance.findById(req.body.bookinstance_id).populate('book').exec(function(err,bookinstance){
      if(err){return next(err);}
...
exports.bookinstance_update_get = function(req, res, next) {
  async.parallel({
      ...
      books: function(callback) {
          ...
          // Success.
          res.render('bookinstance_form', { title: 'Update Copy: ', selected_book: results.bookinstance.book._id , book_list: results.books, bookinstance: results.bookinstance });
      });
};
